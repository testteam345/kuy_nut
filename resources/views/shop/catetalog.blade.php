            ...
            <div class="mv-c-s-content col-xs-12 col-md-8 col-lg-9">
                    ...
                    <div class="block-9-list mv-list-product">
                        ...
                        <article class="col-xs-6 col-sm-4 col-md-6 col-lg-4 item item-product-grid-3 post">
                            <div class="item-inner mv-effect-translate-1 mv-box-shadow-gray-1">
                                <div style="background-color: #fff;" class="content-thumb">
                                    <div class="thumb-inner mv-effect-relative"><a
                                            href="{{route('get_one_product',['id'=>$product->pro_id])}}"
                                            title="{{$product->pro_name}}"><img
                                                src="{{ env('APP_ASSET') }}images/product_img/{{$product->pro_img}}"
                                                alt="demo" class="mv-effect-item"></a><a href="{{route('get_one_product',['id'=>$product->pro_id])}}"
                              ...
                              <ul class="label-2-ul">
                                ...
                                <div class="content-default">
                                    ...
                                    <div class="content-desc"><a href="#"
                                            class="mv-overflow-ellipsis">{{$product->pro_name}}</a></div>
                                </div>
                            ...
                            <button type="button" class="mv-btn mv-btn-style-1 btn-1-h-40 responsive-btn-1-type-1 btn-compare"><span class="btn-inner"><i class="btn-icon fa fa-signal"></i><span class="btn-text">compare</span></span></button> --}}
                                            ...
                                            <button type="button" onclick="add_item_to_cart({{$product->pro_id}})"
                                                class="mv-btn mv-btn-style-3 btn-3-h-40 responsive-btn-3-type-1 btn-add-to-cart"><i
                                                    class="fa fa-cart-plus"></i></button>
                                            @else
                                            <button type="button" data-toggle="modal" data-target="#popupNewsletter"
                                                onclick="set_secion({{$product->pro_id}})"
                                                class="mv-btn mv-btn-style-3 btn-3-h-40 responsive-btn-3-type-1 btn-add-to-cart"><i
                                                    class="fa fa-cart-plus"></i></button>
                                            @endif
                                        </div>
                ...
                <div class="mv-pagination-wrapper">
                    <div class="mv-pagination-style-1 has-count-post">
                        <div class="count-post mv-title-style-10"><span class="number">12</span> Products of <span
                                class="number">5</span> Pages</div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="mv-slider-range">
                                    ...
                                    <div class="mv-dp-table align-middle">
                                        <div class="mv-dp-table-cell view-values">Price: ฿<span
                                                class="min-value">100</span> - ฿<span class="max-value">10000</span>
                                        </div>
                            ...
                            <nav class="filter-by-price-menu mv-menu-style-1">
                                <ul>
                                    ...
                                    <li><a href="#" class="mv-icon-left-style-5">฿500 - ฿1000<span
                                                class="sub-text">&nbsp; (8)</span></a></li>
                                    <li><a href="#" class="mv-icon-left-style-5">฿1000 - ฿2000<span
                                                class="sub-text">&nbsp; (3)</span></a></li>
                                    <li><a href="#" class="mv-icon-left-style-5">฿2000 - ฿3000<span
                                                class="sub-text">&nbsp; (16)</span></a></li>
                                    <li><a href="#" class="mv-icon-left-style-5">฿3000 - ฿10000<span
                        ...
                        <div class="aside-body">
                            <div class="tag-list">
                                <div class="mv-btn-group">
                                    <div class="group-inner"><a href="#" class="mv-btn mv-btn-style-22">ADIDAS</a><a
                                            href="#" class="mv-btn mv-btn-style-22 active">NIKE</a><a href="#"
                                            class="mv-btn mv-btn-style-22">PUMA</a><a href="#"
                                            class="mv-btn mv-btn-style-22">UHLSPORT</a><a href="#"
                                            class="mv-btn mv-btn-style-22">REUSCH</a><a href="#"
                                            class="mv-btn mv-btn-style-22">AVIATA</a><a href="#"
                                            class="mv-btn mv-btn-style-22">APD</a><a href="#"
                                            class="mv-btn mv-btn-style-22">SELLS</a><a href="#"
                                            class="mv-btn mv-btn-style-22">Ho Soccer</a></div>
                                </div>
                            </div>
                        </div>
                    </div> --}}
